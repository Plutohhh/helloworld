      ...
      <el-container>
        ...
        <el-main>
          ...
          <el-table :data="tableData" style="width: 100%" class="eltable"
            ...
            <el-table-column  align="center" label="班次id" width="100">
              <template slot-scope="scope">
                <span style="margin-left: 0px">{{ scope.row.cid }}</span>
              </template>
            </el-table-column>
            ...
            <el-table-column align="center"  label="上班时间">
              <template slot-scope="scope">
                <span style="margin-left: 0px">{{ scope.row.cwork }}</span>
              </template>
            </el-table-column>
            <el-table-column  align="center" label="下班时间">
              <template slot-scope="scope">
                <span style="margin-left: 0px">{{ scope.row.coff }}</span>
              </template>
            </el-table-column>
          ...
          >
            ...
            <el-form
              ...
              :rules="addFormRules"
            >
              <el-form-item label="班次名" prop="cname">
                <el-input v-model="addForm.cname"></el-input>
              </el-form-item>
              <el-form-item label="上班时间" prop="cwork">
                <el-time-picker
                  v-model="addForm.cwork"
                  format="HH:mm"
                  value-format="HH:mm"
                  :picker-options="{
                    selectableRange: '6:30:00 - 15:30:00',
                  }"
                  placeholder="上班时间"
                >
                </el-time-picker>
              </el-form-item>
              <el-form-item label="下班时间" prop="coff">
                <el-time-picker
                  arrow-control
                  v-model="addForm.coff"
                  format="HH:mm"
                  value-format="HH:mm"
                  :picker-options="{
                    selectableRange: '15:30:00 - 24:00:00',
                  }"
                  placeholder="下班时间"
                >
                </el-time-picker>
...
export default {
  ...
  methods: {
    ...
    //弹出编辑框
    handleEdit(cid, cname, cwork, coff) {
      this.editDialogVisible = true;
      this.editForm.cid = cid;
      this.editForm.cname = cname;
      this.editForm.cwork = cwork;
      this.editForm.coff = coff;
    ...
    async handleDelete(id) {
      ...
      if (confirmResult != "confirm") {
        ...
        await this.$axios.delete("/deleteClass?cid=" + id);
        // console.log("========"+data);
